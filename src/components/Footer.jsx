...
const Footer = () => {
    ...
    const socialLinks = [
        {
            name: 'GitHub',
            url: 'https://github.com/Santiagodutr',
            icon: (
        ...
        {
            name: 'LinkedIn',
            url: 'https://www.linkedin.com/in/santiago-duarte-triana/',
            icon: (
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
        ...
        {
            name: 'Twitter',
            url: 'https://x.com/duarte_san72148',
            icon: (
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
        ...
        {
            name: 'Email',
            url: 'mailto:santiagoduarteopcional@gmail.com',
            icon: (
